...
public class ChessGame {
    ...
    private void generateValidCastles(TeamColor teamColor, ArrayList<ChessMove> castleMoves, ChessPosition kingSquare,
                                      ChessPiece blackKing, ChessPosition f8, ChessPosition g8) {
